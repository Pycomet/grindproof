    ...
    <div className="min-h-screen bg-zinc-50 dark:bg-zinc-950">
      <div className="container mx-auto px-4 py-12 max-w-4xl">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-4xl font-bold text-zinc-900 dark:text-white mb-2">Terms of Use</h1>
        ...
        <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-lg p-8 shadow-sm">
          <div className="prose prose-zinc dark:prose-invert max-w-none">
            ...
            <section id="description" className="mb-8">
              ...
              <ul className="text-zinc-700 dark:text-zinc-300 space-y-2 mb-4">
            ...
            <section id="eligibility" className="mb-8">
              <h2 className="text-2xl font-bold text-zinc-900 dark:text-white mb-4">3. Eligibility</h2>
              <p className="text-zinc-700 dark:text-zinc-300 mb-4">
            ...
            <section id="account" className="mb-8">
              <h2 className="text-2xl font-bold text-zinc-900 dark:text-white mb-4">4. Account Registration and Security</h2>
              
              <h3 className="text-xl font-semibold text-zinc-900 dark:text-white mb-3">4.1 Account Creation</h3>
              <p className="text-zinc-700 dark:text-zinc-300 mb-4">
              ...
              <h3 className="text-xl font-semibold text-zinc-900 dark:text-white mb-3">4.2 Account Security</h3>
              <p className="text-zinc-700 dark:text-zinc-300 mb-4">
              ...
              <h3 className="text-xl font-semibold text-zinc-900 dark:text-white mb-3">4.3 Account Restrictions</h3>
              <p className="text-zinc-700 dark:text-zinc-300">
            ...
            <section id="acceptable-use" className="mb-8">
              <h2 className="text-2xl font-bold text-zinc-900 dark:text-white mb-4">5. Acceptable Use Policy</h2>
              <p className="text-zinc-700 dark:text-zinc-300 mb-4">
            ...
            <section id="user-content" className="mb-8">
              <h2 className="text-2xl font-bold text-zinc-900 dark:text-white mb-4">6. User Content</h2>
              
              <h3 className="text-xl font-semibold text-zinc-900 dark:text-white mb-3">6.1 Your Content</h3>
              <p className="text-zinc-700 dark:text-zinc-300 mb-4">
              ...
              <h3 className="text-xl font-semibold text-zinc-900 dark:text-white mb-3">6.2 Content Responsibility</h3>
              <p className="text-zinc-700 dark:text-zinc-300 mb-4">
              ...
              <h3 className="text-xl font-semibold text-zinc-900 dark:text-white mb-3">6.3 Content Removal</h3>
              <p className="text-zinc-700 dark:text-zinc-300">
            ...
            <section id="intellectual-property" className="mb-8">
              <h2 className="text-2xl font-bold text-zinc-900 dark:text-white mb-4">7. Intellectual Property Rights</h2>
              
              <h3 className="text-xl font-semibold text-zinc-900 dark:text-white mb-3">7.1 Service Ownership</h3>
              <p className="text-zinc-700 dark:text-zinc-300 mb-4">
              ...
              <h3 className="text-xl font-semibold text-zinc-900 dark:text-white mb-3">7.2 Limited License</h3>
              <p className="text-zinc-700 dark:text-zinc-300 mb-4">
              ...
              <h3 className="text-xl font-semibold text-zinc-900 dark:text-white mb-3">7.3 Trademarks</h3>
              <p className="text-zinc-700 dark:text-zinc-300">
            ...
            <section id="third-party" className="mb-8">
              <h2 className="text-2xl font-bold text-zinc-900 dark:text-white mb-4">8. Third-Party Integrations</h2>
              <p className="text-zinc-700 dark:text-zinc-300 mb-4">
            ...
            <section id="termination" className="mb-8">
              ...
              <h3 className="text-xl font-semibold text-zinc-900 dark:text-white mb-3">9.1 Termination by You</h3>
              <p className="text-zinc-700 dark:text-zinc-300 mb-4">
              ...
              <h3 className="text-xl font-semibold text-zinc-900 dark:text-white mb-3">9.2 Termination by Us</h3>
              <p className="text-zinc-700 dark:text-zinc-300 mb-4">
              ...
              <h3 className="text-xl font-semibold text-zinc-900 dark:text-white mb-3">9.3 Effect of Termination</h3>
              <p className="text-zinc-700 dark:text-zinc-300">
            ...
            <section id="disclaimers" className="mb-8">
              <h2 className="text-2xl font-bold text-zinc-900 dark:text-white mb-4">10. Disclaimers</h2>
              <div className="bg-yellow-50 border border-yellow-200 dark:bg-yellow-900/20 dark:border-yellow-700/50 p-4 rounded-lg mb-4">
                <p className="text-zinc-700 dark:text-zinc-300 font-semibold mb-2">IMPORTANT LEGAL NOTICE</p>
            ...
            <section id="limitation" className="mb-8">
              <h2 className="text-2xl font-bold text-zinc-900 dark:text-white mb-4">11. Limitation of Liability</h2>
              <div className="bg-red-50 border border-red-200 dark:bg-red-900/20 dark:border-red-700/50 p-4 rounded-lg mb-4">
                <p className="text-zinc-700 dark:text-zinc-300 font-semibold mb-2">LIMITATION OF LIABILITY</p>
                <p className="text-zinc-700 dark:text-zinc-300 text-sm">
            ...
            <section id="indemnification" className="mb-8">
              <h2 className="text-2xl font-bold text-zinc-900 dark:text-white mb-4">12. Indemnification</h2>
              <p className="text-zinc-700 dark:text-zinc-300 mb-4">
            ...
            <section id="modifications" className="mb-8">
              <h2 className="text-2xl font-bold text-zinc-900 dark:text-white mb-4">13. Modifications to Service</h2>
              <p className="text-zinc-700 dark:text-zinc-300 mb-4">
            ...
            <section id="governing-law" className="mb-8">
              <h2 className="text-2xl font-bold text-zinc-900 dark:text-white mb-4">14. Governing Law</h2>
              <p className="text-zinc-700 dark:text-zinc-300 mb-4">
            ...
            <section id="dispute-resolution" className="mb-8">
              <h2 className="text-2xl font-bold text-zinc-900 dark:text-white mb-4">15. Dispute Resolution</h2>
              
              <h3 className="text-xl font-semibold text-zinc-900 dark:text-white mb-3">15.1 Informal Resolution</h3>
              <p className="text-zinc-700 dark:text-zinc-300 mb-4">
              ...
              <h3 className="text-xl font-semibold text-zinc-900 dark:text-white mb-3">15.2 Binding Arbitration</h3>
              <p className="text-zinc-700 dark:text-zinc-300 mb-4">
              ...
              <h3 className="text-xl font-semibold text-zinc-900 dark:text-white mb-3">15.3 Class Action Waiver</h3>
              <p className="text-zinc-700 dark:text-zinc-300">
            ...
            <section id="general" className="mb-8">
              <h2 className="text-2xl font-bold text-zinc-900 dark:text-white mb-4">16. General Provisions</h2>
              
              <h3 className="text-xl font-semibold text-zinc-900 dark:text-white mb-3">16.1 Entire Agreement</h3>
              <p className="text-zinc-700 dark:text-zinc-300 mb-4">
              ...
              <h3 className="text-xl font-semibold text-zinc-900 dark:text-white mb-3">16.2 Severability</h3>
              <p className="text-zinc-700 dark:text-zinc-300 mb-4">
                If any provision of these Terms is found to be invalid or unenforceable, the remaining provisions shall remain in full force and effect.
              </p>

              <h3 className="text-xl font-semibold text-zinc-900 dark:text-white mb-3">16.3 Waiver</h3>
              <p className="text-zinc-700 dark:text-zinc-300 mb-4">
                Our failure to enforce any right or provision of these Terms shall not constitute a waiver of such right or provision.
              </p>

              <h3 className="text-xl font-semibold text-zinc-900 dark:text-white mb-3">16.4 Assignment</h3>
              <p className="text-zinc-700 dark:text-zinc-300 mb-4">
              ...
              <h3 className="text-xl font-semibold text-zinc-900 dark:text-white mb-3">16.5 No Agency</h3>
              <p className="text-zinc-700 dark:text-zinc-300">
            ...
            <section id="contact" className="mb-8">
              <h2 className="text-2xl font-bold text-zinc-900 dark:text-white mb-4">17. Contact Information</h2>
              <p className="text-zinc-700 dark:text-zinc-300 mb-4">
            ...
            <section className="mt-12 pt-8 border-t border-zinc-700">
              <div className="bg-blue-50 border border-blue-200 dark:bg-blue-900/20 dark:border-blue-700/50 p-4 rounded-lg">
                <p className="text-zinc-700 dark:text-zinc-300 font-semibold mb-2">Acknowledgment</p>
                <p className="text-zinc-700 dark:text-zinc-300 text-sm">
