    ...
    <div className="min-h-screen bg-background text-foreground">
      <div className="container mx-auto px-4 py-12 max-w-4xl">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-4xl font-bold text-zinc-50 mb-2 font-[family-name:var(--font-space-grotesk)]">Terms of Use</h1>
          ...
          <div className="max-w-none">
            ...
            <nav className="mb-8 p-4 bg-zinc-800 rounded-lg">
              ...
              <ul className="space-y-2 text-sm">
                <li><a href="#acceptance" className="text-brand hover:text-brand/80 transition-colors">1. Acceptance of Terms</a></li>
                <li><a href="#description" className="text-brand hover:text-brand/80 transition-colors">2. Description of Service</a></li>
                <li><a href="#eligibility" className="text-brand hover:text-brand/80 transition-colors">3. Eligibility</a></li>
                <li><a href="#account" className="text-brand hover:text-brand/80 transition-colors">4. Account Registration and Security</a></li>
                <li><a href="#acceptable-use" className="text-brand hover:text-brand/80 transition-colors">5. Acceptable Use Policy</a></li>
                <li><a href="#user-content" className="text-brand hover:text-brand/80 transition-colors">6. User Content</a></li>
                <li><a href="#intellectual-property" className="text-brand hover:text-brand/80 transition-colors">7. Intellectual Property Rights</a></li>
                <li><a href="#third-party" className="text-brand hover:text-brand/80 transition-colors">8. Third-Party Integrations</a></li>
                <li><a href="#termination" className="text-brand hover:text-brand/80 transition-colors">9. Termination</a></li>
                <li><a href="#disclaimers" className="text-brand hover:text-brand/80 transition-colors">10. Disclaimers</a></li>
                <li><a href="#limitation" className="text-brand hover:text-brand/80 transition-colors">11. Limitation of Liability</a></li>
                <li><a href="#indemnification" className="text-brand hover:text-brand/80 transition-colors">12. Indemnification</a></li>
                <li><a href="#modifications" className="text-brand hover:text-brand/80 transition-colors">13. Modifications to Service</a></li>
                <li><a href="#governing-law" className="text-brand hover:text-brand/80 transition-colors">14. Governing Law</a></li>
                <li><a href="#dispute-resolution" className="text-brand hover:text-brand/80 transition-colors">15. Dispute Resolution</a></li>
                <li><a href="#general" className="text-brand hover:text-brand/80 transition-colors">16. General Provisions</a></li>
                <li><a href="#contact" className="text-brand hover:text-brand/80 transition-colors">17. Contact Information</a></li>
              </ul>
            </nav>

            {/* Acceptance of Terms */}
            <section id="acceptance" className="mb-8">
              <h2 className="text-2xl font-bold text-zinc-50 mb-4 font-[family-name:var(--font-space-grotesk)]">1. Acceptance of Terms</h2>
            ...
            <section id="description" className="mb-8">
              <h2 className="text-2xl font-bold text-zinc-50 mb-4 font-[family-name:var(--font-space-grotesk)]">2. Description of Service</h2>
              <p className="text-zinc-300 mb-4">
            ...
            <section id="eligibility" className="mb-8">
              <h2 className="text-2xl font-bold text-zinc-50 mb-4 font-[family-name:var(--font-space-grotesk)]">3. Eligibility</h2>
              <p className="text-zinc-300 mb-4">
            ...
            <section id="account" className="mb-8">
              <h2 className="text-2xl font-bold text-zinc-50 mb-4 font-[family-name:var(--font-space-grotesk)]">4. Account Registration and Security</h2>
              
              <h3 className="text-xl font-semibold text-zinc-50 mb-3 font-[family-name:var(--font-space-grotesk)]">4.1 Account Creation</h3>
              <p className="text-zinc-300 mb-4">
              ...
              <h3 className="text-xl font-semibold text-zinc-50 mb-3 font-[family-name:var(--font-space-grotesk)]">4.2 Account Security</h3>
              <p className="text-zinc-300 mb-4">
              ...
              <h3 className="text-xl font-semibold text-zinc-50 mb-3 font-[family-name:var(--font-space-grotesk)]">4.3 Account Restrictions</h3>
              <p className="text-zinc-300">
            ...
            <section id="acceptable-use" className="mb-8">
              <h2 className="text-2xl font-bold text-zinc-50 mb-4 font-[family-name:var(--font-space-grotesk)]">5. Acceptable Use Policy</h2>
              <p className="text-zinc-300 mb-4">
            ...
            <section id="user-content" className="mb-8">
              <h2 className="text-2xl font-bold text-zinc-50 mb-4 font-[family-name:var(--font-space-grotesk)]">6. User Content</h2>
              
              <h3 className="text-xl font-semibold text-zinc-50 mb-3 font-[family-name:var(--font-space-grotesk)]">6.1 Your Content</h3>
              <p className="text-zinc-300 mb-4">
              ...
              <h3 className="text-xl font-semibold text-zinc-50 mb-3 font-[family-name:var(--font-space-grotesk)]">6.2 Content Responsibility</h3>
              <p className="text-zinc-300 mb-4">
              ...
              <h3 className="text-xl font-semibold text-zinc-50 mb-3 font-[family-name:var(--font-space-grotesk)]">6.3 Content Removal</h3>
              <p className="text-zinc-300">
            ...
            <section id="intellectual-property" className="mb-8">
              <h2 className="text-2xl font-bold text-zinc-50 mb-4 font-[family-name:var(--font-space-grotesk)]">7. Intellectual Property Rights</h2>
              
              <h3 className="text-xl font-semibold text-zinc-50 mb-3 font-[family-name:var(--font-space-grotesk)]">7.1 Service Ownership</h3>
              <p className="text-zinc-300 mb-4">
              ...
              <h3 className="text-xl font-semibold text-zinc-50 mb-3 font-[family-name:var(--font-space-grotesk)]">7.2 Limited License</h3>
              <p className="text-zinc-300 mb-4">
              ...
              <h3 className="text-xl font-semibold text-zinc-50 mb-3 font-[family-name:var(--font-space-grotesk)]">7.3 Trademarks</h3>
              <p className="text-zinc-300">
            ...
            <section id="third-party" className="mb-8">
              <h2 className="text-2xl font-bold text-zinc-50 mb-4 font-[family-name:var(--font-space-grotesk)]">8. Third-Party Integrations</h2>
              <p className="text-zinc-300 mb-4">
            ...
            <section id="termination" className="mb-8">
              <h2 className="text-2xl font-bold text-zinc-50 mb-4 font-[family-name:var(--font-space-grotesk)]">9. Termination</h2>
              
              <h3 className="text-xl font-semibold text-zinc-50 mb-3 font-[family-name:var(--font-space-grotesk)]">9.1 Termination by You</h3>
              <p className="text-zinc-300 mb-4">
              ...
              <h3 className="text-xl font-semibold text-zinc-50 mb-3 font-[family-name:var(--font-space-grotesk)]">9.2 Termination by Us</h3>
              <p className="text-zinc-300 mb-4">
              ...
              <h3 className="text-xl font-semibold text-zinc-50 mb-3 font-[family-name:var(--font-space-grotesk)]">9.3 Effect of Termination</h3>
              <p className="text-zinc-300">
            ...
            <section id="disclaimers" className="mb-8">
              <h2 className="text-2xl font-bold text-zinc-50 mb-4 font-[family-name:var(--font-space-grotesk)]">10. Disclaimers</h2>
              <div className="bg-yellow-50 border border-yellow-200 dark:bg-yellow-900/20 dark:border-yellow-700/50 p-4 rounded-lg mb-4">
            ...
            <section id="limitation" className="mb-8">
              <h2 className="text-2xl font-bold text-zinc-50 mb-4 font-[family-name:var(--font-space-grotesk)]">11. Limitation of Liability</h2>
              <div className="bg-red-50 border border-red-200 dark:bg-red-900/20 dark:border-red-700/50 p-4 rounded-lg mb-4">
            ...
            <section id="indemnification" className="mb-8">
              <h2 className="text-2xl font-bold text-zinc-50 mb-4 font-[family-name:var(--font-space-grotesk)]">12. Indemnification</h2>
              <p className="text-zinc-300 mb-4">
            ...
            <section id="modifications" className="mb-8">
              <h2 className="text-2xl font-bold text-zinc-50 mb-4 font-[family-name:var(--font-space-grotesk)]">13. Modifications to Service</h2>
              <p className="text-zinc-300 mb-4">
            ...
            <section id="governing-law" className="mb-8">
              <h2 className="text-2xl font-bold text-zinc-50 mb-4 font-[family-name:var(--font-space-grotesk)]">14. Governing Law</h2>
              <p className="text-zinc-300 mb-4">
            ...
            <section id="dispute-resolution" className="mb-8">
              <h2 className="text-2xl font-bold text-zinc-50 mb-4 font-[family-name:var(--font-space-grotesk)]">15. Dispute Resolution</h2>
              
              <h3 className="text-xl font-semibold text-zinc-50 mb-3 font-[family-name:var(--font-space-grotesk)]">15.1 Informal Resolution</h3>
              <p className="text-zinc-300 mb-4">
              ...
              <h3 className="text-xl font-semibold text-zinc-50 mb-3 font-[family-name:var(--font-space-grotesk)]">15.2 Binding Arbitration</h3>
              <p className="text-zinc-300 mb-4">
              ...
              <h3 className="text-xl font-semibold text-zinc-50 mb-3 font-[family-name:var(--font-space-grotesk)]">15.3 Class Action Waiver</h3>
              <p className="text-zinc-300">
            ...
            <section id="general" className="mb-8">
              <h2 className="text-2xl font-bold text-zinc-50 mb-4 font-[family-name:var(--font-space-grotesk)]">16. General Provisions</h2>
              
              <h3 className="text-xl font-semibold text-zinc-50 mb-3 font-[family-name:var(--font-space-grotesk)]">16.1 Entire Agreement</h3>
              <p className="text-zinc-300 mb-4">
              ...
              <h3 className="text-xl font-semibold text-zinc-50 mb-3 font-[family-name:var(--font-space-grotesk)]">16.2 Severability</h3>
              <p className="text-zinc-300 mb-4">
                If any provision of these Terms is found to be invalid or unenforceable, the remaining provisions shall remain in full force and effect.
              </p>

              <h3 className="text-xl font-semibold text-zinc-50 mb-3 font-[family-name:var(--font-space-grotesk)]">16.3 Waiver</h3>
              <p className="text-zinc-300 mb-4">
                Our failure to enforce any right or provision of these Terms shall not constitute a waiver of such right or provision.
              </p>

              <h3 className="text-xl font-semibold text-zinc-50 mb-3 font-[family-name:var(--font-space-grotesk)]">16.4 Assignment</h3>
              <p className="text-zinc-300 mb-4">
              ...
              <h3 className="text-xl font-semibold text-zinc-50 mb-3 font-[family-name:var(--font-space-grotesk)]">16.5 No Agency</h3>
              <p className="text-zinc-300">
            ...
            <section id="contact" className="mb-8">
              <h2 className="text-2xl font-bold text-zinc-50 mb-4 font-[family-name:var(--font-space-grotesk)]">17. Contact Information</h2>
              <p className="text-zinc-300 mb-4">
            ...
            <section className="mt-12 pt-8 border-t border-zinc-700">
              <div className="bg-blue-50 border border-blue-200 dark:bg-blue-900/20 dark:border-blue-700/50 p-4 rounded-lg">
