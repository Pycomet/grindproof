        ...
        <div className="bg-zinc-900 border border-zinc-800 rounded-md p-8">
          <div className="max-w-none">
            ...
            <section id="data-storage" className="mb-8">
              <h2 className="text-2xl font-bold text-zinc-900 dark:text-white mb-4">4. Data Storage and Security</h2>
            ...
            <section id="third-party" className="mb-8">
              ...
              <h3 className="text-xl font-semibold text-zinc-900 dark:text-white mb-3">5.1 Supabase</h3>
              <p className="text-zinc-700 dark:text-zinc-300 mb-4">
              ...
              <h3 className="text-xl font-semibold text-zinc-900 dark:text-white mb-3">5.2 GitHub</h3>
              <p className="text-zinc-700 dark:text-zinc-300 mb-4">
              ...
              <h3 className="text-xl font-semibold text-zinc-900 dark:text-white mb-3">5.3 Google Calendar</h3>
              <p className="text-zinc-700 dark:text-zinc-300 mb-4">
            ...
            <section id="your-rights" className="mb-8">
              ...
              <h3 className="text-xl font-semibold text-zinc-900 dark:text-white mb-3">6.2 GDPR Rights (European Users)</h3>
              <p className="text-zinc-700 dark:text-zinc-300 mb-4">
              ...
              <h3 className="text-xl font-semibold text-zinc-900 dark:text-white mb-3">6.3 CCPA Rights (California Users)</h3>
              <p className="text-zinc-700 dark:text-zinc-300 mb-4">
            ...
            <section id="cookies" className="mb-8">
              <h2 className="text-2xl font-bold text-zinc-900 dark:text-white mb-4">7. Cookies and Local Storage</h2>
              <p className="text-zinc-700 dark:text-zinc-300 mb-4">
            ...
            <section id="changes" className="mb-8">
              <h2 className="text-2xl font-bold text-zinc-900 dark:text-white mb-4">9. Changes to This Policy</h2>
              <p className="text-zinc-700 dark:text-zinc-300 mb-4">
            ...
            <section id="contact" className="mb-8">
              <h2 className="text-2xl font-bold text-zinc-900 dark:text-white mb-4">10. Contact Us</h2>
              <p className="text-zinc-700 dark:text-zinc-300 mb-4">
