      ...
      <div className="w-full max-w-md">
        <div className="mb-8 flex flex-col items-center">
          ...
          <p className="mt-4 text-sm text-zinc-300">
            Three steps. Tomorrow morning, we start.
          </p>
        </div>
        ...
        <form onSubmit={handleSignup} className="mt-8 space-y-4">
          ...
          <div className="flex items-start gap-3">
            <input
              ...
              required
              className="mt-1 h-4 w-4 rounded border-zinc-700 bg-zinc-900 accent-brand"
            />
            <label htmlFor="terms" className="text-sm text-zinc-300">
              ...
              <Link
                ...
                className="font-medium text-brand underline hover:text-brand/80 transition-colors"
              >
                Terms of Use
              </Link>{' '}
              and{' '}
